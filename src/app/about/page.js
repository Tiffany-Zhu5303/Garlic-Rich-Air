...
export default function Home() {
  ...
  return (
    <div>
      {isLoading ? (
                <LoadingScreen backgroundcolor={"bg-[#2B7180]"}/>
      ) : (
        <div className="p-4 flex bg-[var(--aboutbackground)] flex-col items-center min-w-screen min-h-screen">
          <Navbar />
          <div className="flex flex-col items-center justify-center screen-h-75">
            ...
            <div className="p-10 mt-20 leading-quarter flex flex-col gap-8 text-xl">
              ...
              <p>Source: https://anthology.rhizome.org/garlic-rich-air</p>
            </div>
          </div>
        </div>
      )}
